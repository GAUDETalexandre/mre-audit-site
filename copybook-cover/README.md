...
(`source/copybook_cover_contest_original.png`) avec trois modifications :
...
Le cadre fin du dessin passe à environ 3 à 4 mm du bord de la feuille. Sur une
imprimante qui ne gère pas l'impression sans marge, choisir « ajuster à la page »
pour être sûr de ne pas le rogner.
