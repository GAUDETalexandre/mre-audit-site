...
const CHIFFRES = [
  ...
  { valeur: "229", unite: "détecteurs en production", detail: "Chiffre vérifié au 17/05/2026 par scan exhaustif du code source du moteur (6 patterns d'émission, validation 1 par 1, 3 runs successifs identiques). Couvre PRIIPs · DDA · POG · SFDR · Solvabilité 2 · fiscalité 125-0 A / 990 I / 757 B CGI · eurocroissance · Loi Industrie Verte · structurés · Sapin 2 · contrats mixtes AV+retraite · concentration et tunnel intra-groupe · UCITS · jurisprudence ACPR" },
