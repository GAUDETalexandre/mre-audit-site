...
const CHIFFRES = [
  { valeur: "53 659", unite: "PDF en bibliothèque", detail: "Bibliothèque vivante au 11/06/2026 · 11 920 ISIN avec DIC capturé · 1 122 781 ISIN en watchlist · SRI renseigné sur 87,9 % des supports indexés, frais courants sur 75,6 % · découverte ESMA FIRDS automatique · auto-alimentation MRE → biblio des DIC clients indexés" },
  { valeur: "330+", unite: "détecteurs en production", detail: "Chiffre vérifié 05/06/2026 par recompte exhaustif du code source (codes biblio + codes hardcodés des modules du moteur) · validation runtime sur dossiers témoins. Couvre PRIIPs · DDA · POG · SFDR · Solvabilité 2 · fiscalité 125-0 A / 990 I / 757 B CGI · eurocroissance · Loi Industrie Verte · structurés · Sapin 2 · contrats mixtes AV+retraite · concentration et tunnel intra-groupe · UCITS · jurisprudence ACPR · reliquats post-fusion." },
  ...
  { valeur: "35 / 35", unite: "contrôles de non-régression", detail: "Vérifié 11/06/2026 — suite _test_dossiers_temoins : 35 contrôles (compteurs par qualification + codes clés) passés sur 3 dossiers témoins réels anonymisés. Moteur complet du jour : Roland PER 199 obs / AMADEO 174 obs / NOVIAL 160 obs. 38 modules de tests automatisés dans le dépôt (cartographie SGP, concentration, eurocroissance, SFDR, tunnel intra-groupe, couches narratives, routeur, cohérence dashboard/rapport…)." },
